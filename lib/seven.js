...
import  aftertime from 'after-time';
import  englishtime from 'english-time';
import  { EventEmitter } from 'events';
import  levelup from 'levelup';
import  Plevelup from 'then-levelup';


const db = Plevelup(levelup('./seven.db',{encoding: 'json'}));
...
export default class Seven extends EventEmitter{
  ...
  error(err,extra={}){
    ...
    if(!_.find(this._errorDump,{name:err.message})){
